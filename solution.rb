...
class ClickFinder
   ...
   clicks = [
    ...
    def self.get_time_obj_keys(click)
        time_obj_keys = {}
    ...
    def self.filter_for_10_or_more_clicks(clicks)
        click_count = []
    ...
    def self.get_best_time_value_click(time_obj)
        result = []
    ...
    def self.get_clicks_with_in_period(clicks)
    ...
    def self.get_valid_clicks(clicks)
